...
/*
 * swap out the frame to disk. The step is following: 1. find the free
 * slot in swap partition.  2. write the data in buffer to disk
 */
size_t
swap_out (void *frame)
{
   ...
   {
       PANIC("NEED swap partition but no swap partition");
   }
